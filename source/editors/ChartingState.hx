...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['M41NFR4M3 Tweening', "Does the tweening stuff at the beginning of M41NFR4M3."],
		['Hacked Reveal', "Makes sure that everyone's transparency is set perfectly."],
		['Stage Event', 'Does a stage event based on what you entered.\nbounce, rocket, bomb']
	];
