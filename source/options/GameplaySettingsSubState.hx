...
class GameplaySettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Hitsounds', //Name
			'If checked, a sound will play when a note is hit.', //Description
		...
		var option:Option = new Option('Freeplay Dialogue', //Name
			'If checked, freeplay exclusive songs will have dialouge.', //Description
			'freeplayDialogue', //Save data variable name
			'bool', //Variable type
			true); //Default value
		addOption(option);
